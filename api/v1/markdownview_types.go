...
type MarkdownViewStatusPhase string

const (
	MarkdownViewNotReady  = MarkdownViewStatusPhase("NotReady")
	MarkdownViewAvailable = MarkdownViewStatusPhase("Available")
	MarkdownViewHealthy   = MarkdownViewStatusPhase("Healthy")
)

// MarkdownViewStatus defines the observed state of MarkdownView
type MarkdownViewStatus struct {
	//+kubebuilder:validation:Required
	Phase MarkdownViewStatusPhase `json:"phase"`
}
