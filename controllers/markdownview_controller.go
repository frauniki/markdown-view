...
import (
	...
	viewv1 "github.com/frauniki/markdown-view/api/v1"
)
...
//+kubebuilder:rbac:groups=view.sinoa.jp,resources=markdownviews,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=view.sinoa.jp,resources=markdownviews/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=view.sinoa.jp,resources=markdownviews/finalizers,verbs=update
